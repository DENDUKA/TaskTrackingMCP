# Скрипт создания задачи в планировщике Windows для IIS деплоя
# Запускать от имени администратора

$taskName = "TaskTracking-AutoDeploy"
$scriptPath = "C:\Deploy\deploy-iis.ps1"
$intervalMinutes = 5

Write-Host "=== Создание задачи планировщика для IIS ===" -ForegroundColor Green
...
Copy-Item -Path ".\deploy-iis.ps1" -Destination $scriptPath -Force
...
Write-Host "Проверка обновлений каждые $intervalMinutes минут" -ForegroundColor Cyan
